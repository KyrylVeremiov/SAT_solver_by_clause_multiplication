#ifndef SORT_CLAUSES_MAX_MIN_INDEX_H
#define SORT_CLAUSES_MAX_MIN_INDEX_H
...
/*
    ...
    This version sorts by MAX(min_index), meaning:
    clauses with the largest minimum variable index appear first.
...
int sort_clauses_max_min_index(const string& folder_name, const string& filename) {
    ...
    sort(clauses.begin(), clauses.end(),
         [](const vector<int>& a, const vector<int>& b) {
             ...
             // Descending: larger min-index first
